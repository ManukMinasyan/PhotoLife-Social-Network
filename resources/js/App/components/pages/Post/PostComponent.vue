                    ...
                    <article>
                        <b-carousel
                            ...
                            <b-carousel-item v-for="(media, key) in POST.media" :key="key">
                                <template
                                        v-if="media.mime_type === 'image/jpg' || media.mime_type === 'image/jpeg' || media.mime_type === 'image/png' || media.mime_type === 'image/gif'">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('post', ['DELETE_POST', 'LIKE_UNLIKE_POST',
